...
> In this case, I would be interested in knowing: are values for area_mean consistent across diagnositc groups? It is possible that the average area values varies between those that have a malignant tumor. 
...
> 2.2.4: Use a boxplot to look at the frequency of different observations within a single variable. 
>
